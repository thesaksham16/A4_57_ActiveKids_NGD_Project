...
IMPORTANT: This is an example integration. If you did not actually set up these databases during your development,
be transparent in your report. The backend contains illustrative endpoints that will respond for demo purposes.
